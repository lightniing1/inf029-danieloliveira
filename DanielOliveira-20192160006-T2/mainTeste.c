...
void testeListar()
{
    ...
    printf("%d\n", inserirNumeroEmEstrutura(2, -9) == SUCESSO); //2

    int vet[2];

    printf("%d\n", getDadosEstruturaAuxiliar(1, vet) == SEM_ESTRUTURA_AUXILIAR); //3
    printf("%d\n", getDadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA); //4
    printf("%d\n", getDadosEstruturaAuxiliar(2, vet) == SUCESSO); //5

    printf("%d\n", vet[0] == 7); //6
    printf("%d\n", vet[1] == -9); //7

    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(1, vet) == SEM_ESTRUTURA_AUXILIAR); //8
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA); //9
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(2, vet) == SUCESSO); //10

    printf("%d\n", vet[0] == -9); //11
    printf("%d\n", vet[1] == 7); //12

    printf("%d\n", getDadosEstruturaAuxiliar(2, vet) == SUCESSO); //13

    printf("%d\n", vet[0] == 7); //14
    printf("%d\n", vet[1] == -9); //15

    printf("%d\n", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO); //16
    printf("%d\n", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO); //17
    printf("%d\n", excluirNumeroDoFinaldaEstrutura(9) == SUCESSO); //18 //Adicionei esse pois nos proximos teste, exige que as estruturas auxiliares não tenham estruturas dentro
...
void testeRetornarTodosNumeros()
{
    ...
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet1) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS); //1

    printf("%d\n", getDadosOrdenadosDeTodasEstruturasAuxiliares(vet1) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS); //2
            
    printf("%d\n", inserirNumeroEmEstrutura(2, 3) == SUCESSO); //3
    printf("%d\n", inserirNumeroEmEstrutura(2, 8) == SUCESSO); //4
    printf("%d\n", inserirNumeroEmEstrutura(2, 0) == SUCESSO); //5
    

    /*
2 [3,8,0]
*/
    printf("%d\n", criarEstruturaAuxiliar(5, 10) == SUCESSO); //1

    printf("%d\n", inserirNumeroEmEstrutura(5, 1) == SUCESSO);//2
    printf("%d\n", inserirNumeroEmEstrutura(5, 34) == SUCESSO); //3
    printf("%d\n", inserirNumeroEmEstrutura(5, 12) == SUCESSO); //4
    printf("%d\n", inserirNumeroEmEstrutura(5, 6) == SUCESSO); //5
    printf("%d\n", inserirNumeroEmEstrutura(5, 27) == SUCESSO); //6
    printf("%d\n", inserirNumeroEmEstrutura(5, -6) == SUCESSO); //7
...
*/
    ...
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet) == SUCESSO); //1
